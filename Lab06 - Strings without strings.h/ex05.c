#include<stdio.h>
#include<stdlib.h>
/*Ex(5)Repeti o código do ex(4) pois já tinha feito o tratamento de maíúsculas e minúsculas nele.
O programa que lê o nome de duas pessoas e informa se os nomes  são iguais, mostra o nome lido. 
Utilizar getchar() para entrada dos dados. O nome pode ter no máximo 50 caracteres. 
o nome digitado  eh mostrado em letras maiúsculas( Para evitar diferênciação entre miúsculas e minúsculas
